...
public class ReplayVisionRunner implements PhotonVisionRunner {
    ...
    private final Map<VisionIOApriltagsReplay, String> visionIONames;
    private final Map<VisionIOApriltagsReplay, VisionIO.VisionIOInputs> visionIOInputsMap;
    private final Map<VisionIOApriltagsReplay, PhotonPoseEstimator> photonPoseEstimatorMap;
    ...
    public ReplayVisionRunner(
            ...
            final Map<VisionIOApriltagsReplay, VisionIO.VisionIOInputs> visionIOInputsMap
    ) {
        this.visionIOInputsMap = visionIOInputsMap;

        final Map<VisionIOApriltagsReplay, String> visionIONames = new HashMap<>();
        final Map<VisionIOApriltagsReplay, PhotonPoseEstimator> poseEstimatorMap = new HashMap<>();
        for (final VisionIOApriltagsReplay visionIOApriltagsReplay : visionIOInputsMap.keySet()) {
    ...
    public void periodic() {
        ...
        for (
                final Map.Entry<VisionIOApriltagsReplay, VisionIO.VisionIOInputs>
                        photonVisionIOInputsEntry : visionIOInputsMap.entrySet()
        ) {
            final VisionIOApriltagsReplay visionIO = photonVisionIOInputsEntry.getKey();
