...
//    );
    ...
    public static final Pose2d SOURCE_AUTO_NOTE_SEARCH_ENDING_POSE = new Pose2d(
            FIELD_LENGTH_X_METERS / 2,
            Units.inchesToMeters(12),
            Rotation2d.fromDegrees(90)
    );
    public static final Pose2d AMP_AUTO_NOTE_SEARCH_ENDING_POSE = new Pose2d(
            FIELD_LENGTH_X_METERS / 2,
            FIELD_WIDTH_Y_METERS - Units.inchesToMeters(12),
